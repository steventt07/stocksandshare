  ...
  return (
    <div class="container">
      ...
      <div class="categories">
        <h2>Phase 2</h2>
        <p>
          Add in user/trader views and update user interface. Also intergrate
          with broker API to showcase P/L
        </p>
      </div>
      <div class="categories">
        <h2>Phase 3</h2>
      ...
      <div class="categories">
        ...
        <ul>
          ...
          <li>
            Design local file structure for uploading chart data into the
            database
          </li>
